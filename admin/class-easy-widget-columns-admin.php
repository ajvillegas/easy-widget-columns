...
class Easy_Widget_Columns_Admin {
	...
	public function add_admin_menu() {
		...
		add_options_page( esc_html__( 'Easy Widget Columns Settings', 'easy-widget-columns' ), esc_html__( 'Widget Columns', 'easy-widget-columns' ), 'manage_options', $this->plugin_name, array( $this, 'display_settings_page' ) );
	...
	public function add_action_links( $links ) {
		...
		$settings_link = array(
			'<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_name ) . '">' . esc_html__( 'Settings', 'easy-widget-columns' ) . '</a>',
		);
